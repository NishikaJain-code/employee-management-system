  ...
  return (
    <div style={{ fontFamily: "'Outfit', sans-serif", paddingBottom: "40px" }}>
      <div style={{ ...card, padding: "28px 32px", marginBottom: "24px", background: "linear-gradient(135deg, rgba(255,0,229,0.1) 0%, rgba(123,97,255,0.1) 100%)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div>
          <h2 style={{ margin: 0, fontSize: "24px", fontWeight: 800, color: "#f1f5f9" }}>HR Final Approval</h2>
          <p style={{ margin: "6px 0 0", color: "#64748b", fontSize: "14px" }}>Final leave approvals and policy enforcement</p>
        </div>
            ...
            <tbody>
              {leaves.map((leave) => (
                ...
                >
                  ...
                  <td style={{ padding: "14px 16px", color: "#94a3b8" }}>{leave.designation}</td>
              ...
              {leaves.length === 0 && (
                <tr><td colSpan={9} style={{ textAlign: "center", padding: "48px", color: "#64748b" }}>No leave applications found.</td></tr>
              )}
            </tbody>
          </table>
        </div>
